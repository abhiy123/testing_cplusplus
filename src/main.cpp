...
// configuration step. It creates a namespace called `testing_cplusplus`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", testing_cplusplus::cmake::project_name, testing_cplusplus::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", testing_cplusplus::cmake::project_version);
      return EXIT_SUCCESS;
    }
